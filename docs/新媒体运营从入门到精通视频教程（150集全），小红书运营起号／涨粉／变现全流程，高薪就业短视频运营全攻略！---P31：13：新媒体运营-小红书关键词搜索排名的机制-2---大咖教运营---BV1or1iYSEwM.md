# 新媒体运营从入门到精通视频教程（150集全），小红书运营起号／涨粉／变现全流程，高薪就业短视频运营全攻略！ - P31：13：新媒体运营-小红书关键词搜索排名的机制-2 - 大咖教运营 - BV1or1iYSEwM
...
需要对我们的进行内容进行审核，审核的阶段，我们前面讲的就是机器审核对吧，然后驱虫检测人工审核这么几个阶段，一般在机器审核上面没有问题的话，那么你的账号权重还可以的情况下，就会进入正常的一个分发啊。
...
我们前面也给大家讲过，这就是我们审核的第一步，那么第二步呢就是你笔记有没有违规啊，里边的像我们刚才提到的广告词，然后一些像什么什么呃，呃法律不允许的东西，对不对，然后这就是我们需要去考虑的账号。
...
走完之后这个流程你大概就能明白了，OK那么收入啊，笔记收录完了之后是干什么呢，就是对你的一个内容进行一个标签化啊，内容跟标签化，说白了就是给你的内容打标签啊，给你的笔记，笔记的标签登记。
...
一些关键词他分析了你的语义之后，提取你的一些关键词之后，那么后面就需要把你这个笔记，分配到不同的关键词的这个池子当中啊，这个池子当中呢它是有一个罗列的顺序表的啊，这个时候就可以基本上断定初级啊。

给你分配的一个初级的这样的一个排名池子啊，排名池子，那么这个时候后续用户在搜索的时候，如果说没有太大的问题，那么这个索引的这个地方，基本上就决定了你的笔记在这个池子里边的，一个排名的结果了。

K那么剩下的呢还有一个东西啊，这个时候不一定啊，不一定你进入了这个索引的池子里面，有一个基础的排名分值，那么剩下的就是系统还要通过一个东西，就是我们前面讲到的，你的笔记通过了审核之后。
...
但是呢诶你的笔记在这个系统给你推荐了之后，诶发现很多用户都非常喜欢你的数据呃，给他推荐到的这个喜欢穿搭一类的人群里边，他的这个点击率非常高，十个人里面有八个人都会点啊，点完了之后呢，浏览时长都还不错啊。
...
展现给用户，这个时候呢，就是得到了我们最终的一个什么东西啊，就是我们的搜索结果排名啊，搜索结果排名，这就是我们一个小红书，也不光小红书啊，甚至说很多其他搜索平台。
...
第三步就是我们的一个啊笔记标签，对不对，啊第三步是我们的笔记参与收录啊，其实这个过程其实在通过审核了之后，他就已经执行了好，那么第四步就是给我们的笔记，给笔记打标签，什么标签呢。
...
我这里也准备了一些数据啊，我们通过这些数据来再看一下呃，小红书首先第一步对吧，做这样的表格啊，等于第一步啊，是笔记出来，像泰国的椰子汁啊，韩国的爱马仕口红颜色啊，那么这是笔记的标题啊。
...
这当中是涉及到很多很多背后的一些数据的啊，我们运营的话呢，就是我前面跟大家讲的，我们运营笔记，运营小红书，就是要把小红书上面可以做的，每一个细节给它做到完美，那么这些数据上面我们能做得好的时候。
